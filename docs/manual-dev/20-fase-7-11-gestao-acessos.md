...
Quem esqueceu a senha usa **Esqueci minha senha** no login (`/esqueci-senha`). A resposta é sempre genérica. Se o e-mail existir, o Resend envia o link para `/redefinir-senha`.
