#!/usr/bin/env node
/**
 * Aplica migrations em supabase/migrations/ no projeto remoto ClinRoma.
 * Ref: skdtkmruianufgenrlqv · Lê SUPABASE_DB_PASSWORD e NEXT_PUBLIC_SUPABASE_URL de .env.local
 */
...
function resolveEnvPath() {
  ...
  throw new Error(
    `Nenhum .env.local ou .env na raiz. Copie .env.example e defina SUPABASE_DB_PASSWORD.`,
  );
}
